...
def read_args(args: dict[str, Any] | list[str] | None = None) -> dict[str, Any] | list[str]:
    ...
    if sys.argv[1].endswith(".yaml") or sys.argv[1].endswith(".yml"):
        ...
        /root/huzhi/LLaMA-Factory/examples/train_lora/qwen3_lora_sft.yaml
        """
...
def _parse_args(
    ...
    if isinstance(args, dict):
        ...
        (RayArguments(ray_run_name=None, ray_storage_path='./saves', ray_storage_filesystem=None, ray_num_workers=1, resources_per_worker={'GPU': 1}, placement_strategy='PACK', ray_init_kwargs=None),)
        RayArguments(
            ray_run_name=None,
...
def get_train_args(args: dict[str, Any] | list[str] | None = None) -> _TRAIN_CLS:
    ...
    if is_env_enabled("USE_MCA"):
        ...
        TrainingArguments(
            ...
            logging_dir="saves/qwen3-4b/lora/sft/runs/Feb15_16-38-13_k8s-a40-node02",
