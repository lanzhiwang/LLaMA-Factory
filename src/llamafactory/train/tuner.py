...
def _training_function(config: dict[str, Any]) -> None:
    ...
    TrainingArguments(
        ...
        logging_dir=saves/qwen3-4b/lora/sft/runs/Jan06_15-12-39_nj-p-zdtc-h20-059,
